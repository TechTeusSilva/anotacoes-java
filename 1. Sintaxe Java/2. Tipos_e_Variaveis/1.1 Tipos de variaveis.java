...
public class 1.1 Tipos de variaveis {
    ...
    //  existe algumas peculiaridades a trabalhar com alguns tipos específicos.
    public class TipoDados {
       public static void main(String[] args) {
            byte idade = 123;
            short ano = 2021;
            int cep = 21070333; // se começar com zero, talvez tenha que ser outro tipo
            long cpf = 98765432109L; // se começar com zero, talvez tenha que ser outro tipo. Precisar encerrar com L.
